...
gitops_repo_url  = "https://github.com/vaishali1256/gitops-configs.git" # GitOps repository for infrastructure configs (reference only)
argocd_namespace = "argocd"                                          # Namespace where ArgoCD will be deployed

# Application Deployment Configuration 
app_repo_url  = "https://github.com/vaishali1256/gitops-configs.git" # Repository containing your application manifests
app_repo_path = "3tier-configs"                                   # Path within app repository containing Kubernetes manifests
